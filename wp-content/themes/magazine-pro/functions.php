...
if ( !is_page() ) {
	$post_info = '[post_date] <span class="po_in">by [post_author_posts_link]   [post_comments] [post_edit] </span>';
	return $post_info;
}}
...
function sp_footer_creds_filter( $creds ) {
	$creds = '[footer_copyright] &middot; <a href="http://comfortwar.com">comfortwar.com</a> ';
	echo "<strong>contact@comfortwar.com</strong><br>";
	return $creds;
}